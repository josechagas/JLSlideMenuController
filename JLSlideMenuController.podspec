...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  s.description      = "This is a library that makes the hard work to control and create the slide menu for you. It allows you to create a completely customizable menu in a easy way using most of the time only the storyboard and its completely in Swift. I hope it will help you to make your app faster."
